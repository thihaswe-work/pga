  ...
  createBrowserRouter([
...

    {
      ...
      children: [
        ...
        {
          path: paths.app.aboutus.root.path,
          lazy: () =>
            import("./routes/app/aboutus/index").then(convert(queryClient)),
        },
        {
          path: paths.app.aboutus.edit.path,
          lazy: () =>
            import("./routes/app/aboutus/edit").then(convert(queryClient)),
        },
        {
